...
public final class UserDirectJpaDaoTest {

	@Autowired
	private UserDirectJpaDao userDirectJpaDao;
	...
	public void testFindAllUsers() throws Exception {
		...
		List<User> findAll = userDirectJpaDao.findAll();
	...
	// @Test
	/*
	 * public void testFindUsersById() throws Exception { String id = "2"; User user
	 * = userDao.buildBeanId(id); System.out.println(user.toString());
	 * assertNotNull(user); }
	 * 
	 * 
